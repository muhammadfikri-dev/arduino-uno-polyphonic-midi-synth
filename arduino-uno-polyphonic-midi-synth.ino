/**
 * =========================================================================================
 * Project     : Arduino Uno 6-Voice Polyphonic Algorithmic MIDI Synthesizer
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Hardware algorithmic sound synthesizer running on ATmega328P Timer2 PWM, generating 6 simultaneous polyphonic voices, ADSR envelope generators, and MIDI UART input.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno 6-Voice Polyphonic Algorithmic MIDI Synthesizer"));
