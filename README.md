# ⚡ Arduino Uno 6-Voice Polyphonic Algorithmic MIDI Synthesizer
...
Hardware algorithmic sound synthesizer running on ATmega328P Timer2 PWM, generating 6 simultaneous polyphonic voices, ADSR envelope generators, and MIDI UART input.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-polyphonic-midi-synth.ino`](./arduino-uno-polyphonic-midi-synth.ino).
